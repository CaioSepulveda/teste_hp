...
-- Consulta Final: Seleciona campanhas que atendem aos critérios
SELECT
    cm.Campanha,
    cm.CTR,
    mg.Mediana_CTR,
...
WHERE
    cm.CTR < mg.Mediana_CTR
    AND cm.Tx_Conv_Leads > mg.Mediana_Tx_Conv_Leads
ORDER BY
    cm.CTR ASC, cm.Tx_Conv_Leads DESC;